...
ab_r = read.table("./GBlupRandomModel/RnSoln_animal.dat",header=F,skip=1); ab_r = ab_r$V4
ab_rh = read.table("./GBlupRandomModel/RnSoln_herdId.dat",header=F,skip=1); ab_rh = ab_rh$V4
ab_rebv = tail(ab_r,n=as.numeric(args[1]))
ab_rehv = ab_rh
...
print(paste("Random Model : Accuracy of WOMBAT GEBVs is",round(cor(ab_rebv,tgv),digits=3),sep=" ")) ; plot(ab_rebv,tgv,main="WOMBAT GEBV vs TBV : Random Model",pch=16)
