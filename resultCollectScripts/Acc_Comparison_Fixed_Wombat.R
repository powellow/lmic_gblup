...
### Fixed Effect Model Marker Estimates -----------------------
ab_f = read.table("PblupFixedModel/RnSoln_animal.dat",header=F,skip=1); ab_f = ab_f$V4
...
print(paste("Fixed Model : Accuracy of WOMBAT EBVs is",round(cor(ab_febv,tgv),digits=3),sep=" ")) ; plot(ab_febv,tgv,main="WOMBAT EBV vs TBV : Fixed Model",pch=16)
