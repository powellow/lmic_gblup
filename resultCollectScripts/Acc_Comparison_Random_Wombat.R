...
ab_r = read.table("./PblupRandomModel/RnSoln_animal.dat",header=F,skip=1); ab_r = ab_r$V4
ab_rh = read.table("./PblupRandomModel/RnSoln_herdId.dat",header=F,skip=1); ab_rh = ab_rh$V4
